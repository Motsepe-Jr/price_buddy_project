...
def batchWriteCategories(body, token):
    uri = f"{host}/api/v1/admin/categories/new"
...
# get stores
def getCategory(_search_keyword, token):
    
    url = f"{host}/api/v1/categories?keyword={_search_keyword}"
...
def addProduct(body, token):
    uri = f"{host}/api/v1/admin/products/new"
